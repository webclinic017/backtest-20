...
def run_backtest(print_output=True):
    ...
    data = bt.feeds.GenericCSVData(
        dataname=data_set,
        fromdate=datetime(2021, 1, 1, 0, 0, 0),
    ...
    # cerebro.plot()
    # Comment out for pyfolo to run in jupyter
    # figure = cerebro.plot()[0][0]
    # figure.savefig('plot_cryptoflash.png')
...
if __name__ == "__main__":
    ...
    print(
        "Annual Returns:", results_dic["strat"].analyzers.annual_return.get_analysis()
    )
